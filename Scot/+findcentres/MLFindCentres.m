classdef MLFindCentres<findcentres.FindCentres
    methods
        function obj=MLFindCentres (varargin)
            % MLFindCentres --- constructor for an object to run a simple findcentres method that returns the centroids of the latest entry in RequiredImages.Bin
            %
            % Synopsis:  obj = MLFindCentres (varargin)
            %                        
            ...
            obj.parameters.trainingsetfile = 'path';
            obj.paramCall.trainingsetfile = 'uigetfile';
