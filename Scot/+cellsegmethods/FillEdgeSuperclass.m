classdef FillEdgeSuperclass<cellsegmethods.EdgeSuperClass    
    methods (Static)
        function [filledImg]=fillEdge(varargin)
            ...
            % Notes:     This superclass was written to share the fillEdge
            %            method between the Segmethods classes 1-4
            %            For cells in regions that have been split with the
