...
truncated_len = 50;
c0=2;
%U IS THE INITIAL CONTOUR - EVERYTHING IS -2 INSIDE THE CELL
...
mu=1;%PARAMETER CONTROLLING THE CONTOUR LENGTH
lambda1=1; lambda2=1;
timestep = .1;
v=1;%PARAMETER CONTROLLING THE AREA
epsilon=1;
...
for n=1:iterNum
    u=acwe(u, Img,  timestep,...
         ...
         %THE IF LOOP IS JUST FOR DISPLAY
    if mod(n,10)==0
        pause(0.1);
