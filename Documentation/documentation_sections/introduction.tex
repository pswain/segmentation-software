...
\label{sec:intro}
 ...
 \begin{itemize}
 	\item The software requires that the swain lab general functions package also be installed, which can be found \hlcom{here}{add link to this}.
 	...
 	\item It is recommended that you use the software with MATLAB 2015b. Using it with later versions of matlab requires some extra setup steps that are detailed \hlcom{here}{add link to relevant section.}.
 \end{itemize}
