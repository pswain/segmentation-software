...
cExperiment = append_cExperiment(cExperiment,[],num_timepoints,[],[],[],[],pick_pairs);


%% run active contour method
%TODO add load cellVision.
cExperiment.RunActiveContourExperimentTracking(cExperiment.cCellVision,[],1,num_timepoints,true,1,false,false);
