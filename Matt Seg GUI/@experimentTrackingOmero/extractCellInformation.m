...
% if exist([cExperiment.saveFolder cExperiment.rootFolder 'log.txt'])==0
%    [filename, ~]=cExperiment.OmeroDatabase.downloadFile(cExperiment.omeroDs,[cExperiment.rootFolder 'log.txt'],cExperiment.saveFolder);
% 
% end
% cExperiment.parseLogFile([cExperiment.saveFolder cExperiment.rootFolder 'log.txt'],progress_bar);
