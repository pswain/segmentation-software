...
if isequal(extractionParameters.extractFunction,@extractCellDataStandardParfor) ...
    ...
    if ~strcmp(type,'basic')
        ...
        settings_dlg_struct = struct(...
            ...
            'forgotten_field_1',struct('entry_name',{{'nuclear tag field','nuclearChannel'}},'entry_value',{[{'n    not applicable'} subsref(channel_list(:),struct('type','()','subs',{{functionParameters.channels}}))']}),...
