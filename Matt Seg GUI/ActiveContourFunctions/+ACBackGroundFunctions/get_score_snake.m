...
if use_previous_timepoint
            ACscore = ACMethods.CFRadialTimeStack(forcing_image,centre,angles,cat(2,radii_previous_time_point,radii),alpha,betaElco,[siy six],use_previous_timepoint,A,n,breaks,jj,C,region_image);    
        else
            ACscore = ACMethods.CFRadialTimeStack(forcing_image,centre,angles,radii,alpha,betaElco,[siy six],use_previous_timepoint,A,n,breaks,jj,C,region_image);   
        end
