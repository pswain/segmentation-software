...
file='C:\Matt\Aging experiments\June 8 2015 - AL Glc and 0-01per Glc\pos24cTimelapse';
load(file);
cTimelapse.cTimepoint=cTimelapse.cTimepoint(1:25:end-30); 
...
%%
load('C:\Segmentation code\hap5 training\june8 - pos24cTimelapse')
...
load('C:\Segmentation code\hap5 training\jun5 - pos27cTimelapse.mat')
cTimelapse.timepointsToProcess=1:length(cTimelapse.cTimepoint);
cTimelapse.channelsForSegment=[1 2 3]
cTimelapse.timepointsProcessed==1:length(cTimelapse.cTimepoint);
...
if ~strcmp(cCellVision.method,'wholeIm')
    ...
    cCellVision.generateTrainingSetTimelapse_wholeIm(cTimelapseOut,step_size,@(CSVM,image) createImFilterSetCellTrapStackDIC_gpuNew(CSVM,image));
end
toc
