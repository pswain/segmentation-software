...
function filt_feat=createImFilterSetCellTrap_WholeIm(cCellSVM,image)
...
%% Delete this soon
trapG=zeros(size(image));
trapG2=zeros(size(image));
 cCellSVM.cTrap.trapOutline=zeros(size(image))>0;
