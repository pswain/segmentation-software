...
% Last Modified by GUIDE v2.5 30-Dec-2014 13:51:03
...
% --- Executes on button press in checkboxShowEdges.
function checkboxShowEdges_Callback(hObject, eventdata, handles)
% hObject    handle to checkboxShowEdges (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global Image;
...
% --- Executes on button press in checkboxShowNormals.
function checkboxShowNormals_Callback(hObject, eventdata, handles)
% hObject    handle to checkboxShowNormals (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global Image;
global edges;
